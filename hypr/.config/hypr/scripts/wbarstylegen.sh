...
export c_radius=$(( b_height*15/100 ))   # block rad 25% of height {type2}
export t_radius=$(( b_height*25/100 ))   # tooltip rad 25% of height
export e_margin=$(( b_height*10/100 ))   # block margin 30% of height
export e_paddin=$(( b_height*8/100 ))   # block padding 10% of height
export g_margin=$(( b_height*10/100 ))   # module margin 14% of height
...
export s_fontpx=$(( b_height*34/100 ))   # font size 38% of height
